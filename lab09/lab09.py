...
def multiply_lnks(lst_of_lnks):
    ...
    for i in range(len(lst_of_lnks)):
        if not lst_of_lnks[i]:
            return ()
        result.first *= lst_of_lnks[i].first
    result.rest = multiply_lnks([lst_of_lnks[j].rest for j in range(len(lst_of_lnks))])
    return result
...
class Link:
    ...
    def __str__(self):
        ...
        while self.rest is not Link.empty:
            ...
            self = self.rest
        return string + str(self.first) + '>'passphrase = 'beautifulbuffalobridge'
...
class Link:
    ...
    def __str__(self):
        ...
        while self.rest is not Link.empty:
            string += str(self.first) + ' '
            self = self.rest
        return string + str(self.first) + '>'class Link:
    """A linked list.
